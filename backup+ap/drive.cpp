...
void *HWsocketTcp(void *ptr)
{
    ...
    if (index > 0)
    {
        ...
        std::cout << "HWportnum: " << HWportnum << "  "
                  << "HWipaddr: " << HWipaddr << std::endl;
    }
    else
    {
...
void *ZXsocketTcp(void *ptr)
{
    ...
    while (true)
    {
        ...
        */
        ...
        //system("echo \"AT+CSQ\"\r > /dev/ttyUSB5");
        //sleep(3);

        //system("echo \"AT+ZSINR=?\"\r > /dev/ttyUSB5");
        //sleep(3);
...
*/
    ...
    while (true)
    {
        ...
        if (Serial_Mcu.BD_Send && !Socket_is_Send)
        {
            ...
            //printf("\r\n");
            //std::cout << BDPayloadSerial[BDCnt][i] << std::endl;
            //printf("\r\n");
